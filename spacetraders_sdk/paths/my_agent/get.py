...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'Agent': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'Agent': ...
...
class GetMyAgent(BaseApi):
    ...
    def get_my_agent(
        ...
        return self._get_my_agent_oapg(
