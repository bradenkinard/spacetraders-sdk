        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Ship']:
                        return Ship
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Ship'], typing.List['Ship']],
                ...
                def __getitem__(self, i: int) -> 'Ship':
...
class GetMyShips(BaseApi):
    ...
    def get_my_ships(
        ...
        return self._get_my_ships_oapg(
