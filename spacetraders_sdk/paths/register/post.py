...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["faction", "symbol", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["faction", "symbol", ], str]):
