...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['ShipCargo']:
                return ShipCargo
            __annotations__ = {
                "data": data,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'ShipCargo': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'ShipCargo': ...
...
class GetMyShipCargo(BaseApi):
    ...
    def get_my_ship_cargo(
        ...
        return self._get_my_ship_cargo_oapg(
